# -*- coding: utf-8 -*-
"""
UrinaryDiseaseTreacker
Diagnoses urinary conditions based on the colot of the urinie sample
Based on https://github.com/manishsingh7163/Color-Detection/tree/master/Data
"""
import numpy as np
import pandas as pd
import cv2
...
df = pd.read_csv('urinecolors.csv', names = index, header = None)
